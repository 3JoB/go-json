...
![Go](https://github.com/3JoB/go-json/workflows/Go/badge.svg)
[![GoDoc](https://godoc.org/github.com/3JoB/go-json?status.svg)](https://pkg.go.dev/github.com/3JoB/go-json?tab=doc)
...
If you have the API you need, please submit your issue [here](https://github.com/3JoB/go-json/issues).

# Features

- Drop-in replacement of `encoding/json`
- Fast ( See [Benchmark section](https://github.com/3JoB/go-json#benchmarks) )
...
[go-json-fuzz](https://github.com/3JoB/go-json-fuzz) is the repository for fuzzing tests.
If you run the test in this repository and find a bug, please commit to corpus to go-json-fuzz and report the issue to [go-json](https://github.com/3JoB/go-json/issues).
...
The technique for working with `*reflect.rtype` directly from `go-json` is implemented at [rtype.go](https://github.com/3JoB/go-json/blob/master/internal/runtime/rtype.go)
...
If you want to know more, please refer to the implementation [here](https://github.com/3JoB/go-json/blob/master/internal/runtime/type.go#L36-L100)
